        ...
        <div class="sub-content">
            <div class="sub-left-content">
                ...
                <ul>
                    ...
                    <li>クラッシュ・バンディクー1</li>
                    <li>チョコボの不思議なダンジョン2</li>
                    <li>ONE PIECE グランドバトル!</li>
                    <li>PRICEシリーズVol.2 本格将棋指南</li>
                    <li>ドラゴンクエストモンスターズ1・2 星降りの勇者と牧場の仲間たち</li>
                    <li><a href="https://w.atwiki.jp/gcmatome/pages/7975.html" target="_blank">名探偵コナン</a></li>
                    <li><a href="https://www.youtube.com/watch?v=erTgzZPW94I" target="_blank">メタルギアソリッド</a></li>
                    <li><a href="https://www.youtube.com/watch?v=erTgzZPW94I" target="_blank">サルゲッチュ</a></li>
                    <li><a href="https://w.atwiki.jp/gcmatome/pages/1608.html" target="_blank">モンスターファーム2</a></li>
                </ul>
            </div>
            <div class="sub-left-content">
        ...
        <div class="sub-content">
            ...
            <div class="sub-left-content">
                ...
                <ul>
                    <li>真・三國無双1, 2</li>
                    <li>キングダム ハーツ</li>
                    <li>キングダムハーツ ファイナルミックス</li>
                    <li>キングダム ハーツII</li>
                    <li>ぼくのなつやすみ2 海の冒険篇</li>
                    <li>ドラゴンクエストキャラクターズ トルネコの大冒険3 不思議のダンジョン</li>
                    <li>ラチェット&クランク, 2, 3, 4</li>
                    <li>ファイナルファンタジーX-2, Ⅻ</li>
                    <li>モンスターファーム4</li>
                    <li>NARUTO -ナルト- ナルティメットヒーロー1, 2, 3</li>
                    <li>ドラゴンクエストV 天空の花嫁</li>
                    <li>金色のガッシュベル!! 友情タッグバトル</li>
                    <li>イリスのアトリエ エターナルマナ</li>
                    <li>ドラゴンクエストVIII 空と海と大地と呪われし姫君</li>
                    <li>ドラゴンクエスト&ファイナルファンタジー in いただきストリートSpecial</li>
                    <li>モンスターハンターG, 2</li>
                    <li>テイルズ オブ ジ アビス</li>
                    <li>ドラゴンクエスト 少年ヤンガスと不思議のダンジョン</li>
                </ul>
            </div>
        </div>
        <div class="sub-content">
