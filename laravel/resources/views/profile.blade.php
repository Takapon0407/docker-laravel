    ...
    <div class="content-box">
        ...
        <div class="sub-content">
            <div class="sub-left-content">
                <img src="{{ asset('assets/laravel/profile.jpg')}}" alt="profile img" title="profile img" width="100%" height="100%">
            </div>
        ...
        <div class="sub-content">
            <div class="sub-left-content">
                ...
                <ul>
                    ...
                    <li>2024年 2月: <a href="https://aws.amazon.com/jp/certification/certified-developer-associate/" target="_blank">AWS SOA</a></li>
                </ul>
            </div>
            <div class="sub-right-content">
